...
public class ImageCacheManager{
	...
	public static ImageCacheManager getInstance(){
		if(mInstance == null){
			...
			mInstance.init(GuguApplication.getInstance().getApplicationContext(), "image", cacheSize, DISK_IMAGECACHE_COMPRESS_FORMAT, DISK_IMAGECACHE_QUALITY, CacheType.DISK);
		}
	...
	public RequestQueue getRequestQueue() {
		...
		if (mRequestQueue == null) {
			mRequestQueue = Volley.newRequestQueue(GuguApplication.getInstance().getApplicationContext());
		}
