...
public class ActivityUtil {
    ...
    public static SharedPreferences getSharedPreferences() {
        return GuguApplication.getInstance().getSharedPreferences("BAGGUGU", Context.MODE_PRIVATE);
    }
    ...
    public static String getVersionCode() {
        try {
            PackageManager manager = GuguApplication.getInstance().getPackageManager();
            PackageInfo info = manager.getPackageInfo(GuguApplication.getInstance().getPackageName(), 0);
