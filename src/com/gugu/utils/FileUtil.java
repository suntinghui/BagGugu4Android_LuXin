...
public class FileUtil {
    ...
    public static String getFilePath() {
        ...
        String path = Environment.getExternalStorageDirectory() + File.separator + GuguApplication.getInstance().getPackageName() + File.separator;
    ...
    public static String createFolder(String name) {
        String path = Environment.getExternalStorageDirectory() + File.separator + GuguApplication.getInstance().getPackageName() + File.separator + name + File.separator;
