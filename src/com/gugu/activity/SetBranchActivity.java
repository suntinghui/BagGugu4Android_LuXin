...
import com.ares.baggugu.dto.app.TreeNodeAppDto;
import com.gugu.activity.view.SelectCityLayout;
...
public class SetBranchActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void requestSetBranch() {
        ...
        JSONRequest request = new JSONRequest(this, RequestEnum.SECURITY_CENTER_BANK_UPATE_ADDRESS, map, new Response.Listener<String>() {
