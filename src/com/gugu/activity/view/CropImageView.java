...
public class CropImageView extends ImageViewTouchBase {
	...
	public static int CROP_TYPE_CARD = 0x100;
	public static int CROP_TYPE_HEADER = 0x101;
	
	public static int CROP_TYPE = 0;
...
//            }
    ...
    public void resetView(Bitmap b){
        ...
        int cropWidth = 0;
        int cropHeight = 0;
        if (CROP_TYPE == CROP_TYPE_CARD){
        	cropWidth = 402;
        	cropHeight = 249;
        } else if (CROP_TYPE == CROP_TYPE_HEADER) {
