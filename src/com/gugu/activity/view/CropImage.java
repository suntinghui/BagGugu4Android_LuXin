...
import com.gugu.activity.CropImageActivity;
...
public class CropImage {
	...
	public static final File FILE_LOCAL = new File(FILE_SDCARD, "fenqi");
	...
	private Bitmap onSaveClicked(Bitmap bm) {
		...
		if (CropImageView.CROP_TYPE == CropImageView.CROP_TYPE_CARD) {
			width = 402;
			height = 249;
		} else if (CropImageView.CROP_TYPE == CropImageView.CROP_TYPE_HEADER) {
