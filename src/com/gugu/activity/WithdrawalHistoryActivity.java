...
import com.gugu.activity.view.WithdrawalAdapter;
...
@Deprecated
public class WithdrawalHistoryActivity extends BaseActivity implements OnClickListener, OnLoadListener, OnRefreshListener {
	...
	private WithdrawalAdapter adapter = null;
			...
			public void onResponse(String jsonObject) {
				...
				try {
					...
					if (dto.getStatus() == AppResponseStatus.SUCCESS) {
						...
						ActivityUtil.setEmptyView(WithdrawalHistoryActivity.this, listView).setOnClickListener(new OnClickListener() {
							@Override
